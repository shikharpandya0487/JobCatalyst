      ...
      />
        ...
        <div className="flex flex-col md:flex-row gap-5 justify-between text-lg md:text-lg text-black md:flex-wrap mt-5">
          <div className="flex flex-col flex-1 px-5 max-w-full">
            ...
            />
            <label htmlFor="numEmployees" className="mt-3">Your Company’s number of employees:</label>
            <input
              type="text"
              id="numEmployees"
              className="shrink-0 mt-2 md:mt-3 bg-zinc-300 h-[40px] rounded-xl max-w-full"
            />
            <label htmlFor="numEmployees" className="mt-3">Contact Number:</label>
            <input
              type="text"
              id="PhoneNumber"
              className="shrink-0 mt-2 md:mt-3 bg-zinc-300 h-[40px] rounded-xl max-w-full"
          ...
          <div className="flex flex-col flex-1 px-5 max-w-full">
            ...
            <input
              ...
              className="shrink-0 mt-2 md:mt-3 bg-zinc-300 h-[40px] rounded-xl max-w-full"
            />
            <label htmlFor="howYouKnow" className="mt-3">How you came to know about us?</label>
            <input
              type="text"
              id="howYouKnow"
              className="shrink-0 mt-2 md:mt-3 bg-zinc-300 h-[40px] rounded-xl max-w-full"
            />
            <label htmlFor="howYouKnow" className="mt-3">Company Email:</label>
            <input
              type="text"
              id="companyEmail"
              className="shrink-0 mt-2 md:mt-3 bg-zinc-300 h-[40px] rounded-xl max-w-full"
