            ...
            <div className="ml-10 flex items-baseline space-x-4 text-white">
              ...
              {isAuthenticated && (
                <>
                  ...
                  {admin?<div className='text-white cursor-pointer transition-all duration-200 hover:bg-gray-300 px-3 py-2 rounded-md text-md'><Link className='text-gray-200 w-full h-full hover:text-gray-800 hover:font-semibold'style={{ textDecoration: 'none' }}  to="/people">Search people</Link></div>:null}
                 { admin?<div className='text-white cursor-pointer transition-all duration-200 hover:bg-gray-300 px-3 py-2 rounded-md text-md'><Link className='text-gray-200 w-full h-full hover:text-gray-800 hover:font-semibold' style={{ textDecoration: 'none'}}  to="/job-basics">Post Job</Link></div>:null}
