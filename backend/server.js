...
app.use(cors({
  origin: 'https://job-catalyst-51pmb4e0r-shikharpandya0487s-projects.vercel.app/',
  credentials: true 
}));
...
const io = require('socket.io')(server, {
  pingTimeout: 50000,
  cors: {
    origin: 'https://job-catalyst-51pmb4e0r-shikharpandya0487s-projects.vercel.app/', // Specify your frontend URL
    methods: ["GET", "POST"],
    credentials: true
  }
});
